...
function initAudio(){
    //load audio files
    beepX = new Audio('resources/sounds/beepX.mp3');
    beepY = new Audio('resources/sounds/beepY.mp3');
    beepPaddle = new Audio('resources/sounds/beepPaddle.mp3');
    beepGameOver = new Audio('resources/sounds/beepGameOver.mp3');
    bgMusic = new Audio('resources/music/music.mp3');
    //turn off volume
    beepX.volume = 0;
    beepY.volume = 0;
    beepPaddle.volume = 0;
